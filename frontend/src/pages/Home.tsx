...
const CustomPopup: React.FC<{
    ...
    return (
        <div
            className="bg-white rounded-2xl shadow-2xl p-6 min-w-[320px] border border-blue-100 absolute z-[1000] backdrop-blur-sm bg-white/95 transition-all duration-200"
            style={{
                top: `${position.top}px`,
...
const Home: React.FC = () => {
    ...
    const handleCountryClick = (countryId: number) => {
        ...
        // Click qilganda hover ma'lumotlarini saqlaymiz (yo'q qilmaymiz)
    };
    ...
    const handleMarkerMouseOver = (
        ...
        // ENDI BARCHA DAVLATLAR UCHUN HOVER ISHLAYDI (tanlangan ham, tanlanmagan ham)
        ...
        if (markerElement) {
            ...
            if (mapContainer) {
                ...
                const position = {
                    top: rect.top - mapRect.top - 320,
                    left: rect.right - mapRect.left + 10,
                };
    ...
    const handleMarkerMouseOut = () => {
        // Hover tugaganda ma'lumotlarni to'liq olib tashlaymiz
        setHoveredCountry(null);
        setHoverPosition(null);
    };

    // Xarita container'iga mouse leave event qo'shamiz
    useEffect(() => {
